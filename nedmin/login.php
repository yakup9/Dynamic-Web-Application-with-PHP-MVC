...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Giriş bilgilerini girin</p>
      ...
      <?php
       ...
       if (isset($_COOKIE['adminLogin'])) {
        ...
        if (isset($_POST['admin_login'])) {
          ...
          $sonuc=$db->adminLogin(htmlspecialchars($_POST['admin_username']),htmlspecialchars($_POST['admin_pass']),$_POST['remember_me']);
          ...
          if ($sonuc['status']) {
            ...
            ?>
            <div class="alert alert-danger">Başarısız, bilgilerinizi kontrol edin...</div>
            <?php
       ...
       ?>
        ...
        <div class="input-group mb-3">
          ...
          <?php 
           if (isset($_COOKIE['adminLogin'])) {
            echo 'value="'.$login->admin_username.'"';
           }else{
